...
{    
    ...
    */
    ...
    double eta_e = 0.01;
    double eta_mu = -0.01;
    QKE* sim = new QKE(et, eta_e, eta_mu, 0.8, 2.5e-15);

    density* den = new density(et, eta_e, eta_mu);
    den->set_T(0.12);

    /*
    three_vector_for_QKE* dum = new three_vector_for_QKE(0.8, 2.5e-15);
    dum->v_density(et, den);
    dum->print();
    */
    ...
    sim->run(1000,10,5.0e15,"output2.csv");
